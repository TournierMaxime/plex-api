...
class LibraryControllers {
    ...
    async getLibraryMetada(req, res) {
        ...
        res.status(200).json({
            ...
            Image: MediaContainer.Metadata[0].Image &&
                MediaContainer.Metadata[0].Image.map((m) => {
                    return {
                        alt: m.alt,
                        type: m.type,
                        url: m.url,
            ...
            Genre: MediaContainer.Metadata[0].Genre &&
                MediaContainer.Metadata[0].Genre.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
            ...
            Country: MediaContainer.Metadata[0].Country &&
                MediaContainer.Metadata[0].Country.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
            ...
            Guid: MediaContainer.Metadata[0].Guid &&
                MediaContainer.Metadata[0].Guid.map((m) => {
                    return {
                        id: m.id,
                    };
                }),
            Rating: MediaContainer.Metadata[0].Rating &&
                MediaContainer.Metadata[0].Rating.map((m) => {
                    return {
                        image: m.image,
                        value: m.value,
                        type: m.type,
            ...
            Director: MediaContainer.Metadata[0].Director &&
                MediaContainer.Metadata[0].Director.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
            ...
            Writer: MediaContainer.Metadata[0].Writer &&
                MediaContainer.Metadata[0].Writer.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
            ...
            Role: MediaContainer.Metadata[0].Role &&
                MediaContainer.Metadata[0].Role.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
            ...
            Producer: MediaContainer.Metadata[0].Producer &&
                MediaContainer.Metadata[0].Producer.map((m) => {
                    return {
                        id: m.id,
                        filter: m.filter,
                        tag: m.tag,
